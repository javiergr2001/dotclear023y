...
// Database user
define('DC_DBUSER','myfcojavie');

// Database password
define('DC_DBPASSWORD','my8RA4Bz');

// Database name
define('DC_DBNAME','dotclear023y');
...
define('DC_MASTER_KEY','4c791ef9bf61c0a9bd9b162bc82cba3e');

// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL','http://www.fcojavier.es.mialias.net/dotclear/dotclear/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','gomez.ramirez.francisco.javier@iescamas.es');
